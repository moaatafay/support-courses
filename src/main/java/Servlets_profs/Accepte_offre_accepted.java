...
@WebServlet("/projet_V2/prof/Accepte_offre_accepted")
public class Accepte_offre_accepted extends HttpServlet {
	private static final long serialVersionUID = 1L;
   
    public Accepte_offre_accepted() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("Accept_result",0);
		session.setAttribute("refuse_result",-1);
		session.setAttribute("matiereAccept",request.getParameter("matiere"));
		session.setAttribute("emailAccept",request.getParameter("email"));
