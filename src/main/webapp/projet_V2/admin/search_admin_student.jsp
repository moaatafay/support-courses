            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                  ...
                  <c:if test = "${search_student_list_size > 0}">
                  <c:forEach var="i" begin="0" end="${search_student_list_size-1}" step="1">
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image placeholder" src="${search_student_list[i].getImg()}">
                        </a>
                        <div class="media-body">
                          <span class="name mb-0 text-sm">${search_student_list[i].getName()} ${search_student_list[i].getFamily_name()}</span>
                        </div>
                      </div>
                    </th>
                    
                    <td class="">
                      ${search_student_list[i].getEmail()}
                    </td>

                    <td>
                      ${search_student_list[i].getCity()}
                    </td>

                    <td>
                      ${search_student_list[i].getOffres_accepted()}
                    </td>
                    ...
                    <td class="">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          ...
                          <input type="hidden" name="student_to_delete" value="${search_student_list[i].getId_students()}" >
