...
<body>
  ...
  <div class="main-content" id="panel">
          ...
          <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" method="Get" action="search_servlet">
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <input class="form-control" placeholder="Search" name="search_offre" type="text">
              </div>
            </div>
    ...
    <div class="container mt-6">
      ...
      <c:if test = "${delete_success_offre == 1}">
      <div class="delete">
	      	<div class="alert alert-success alert-dismissible fade show" role="alert">
			    <span class="alert-icon"><i class="ni ni-like-2"></i></span>
			    <span class="alert-text"><strong>Success!</strong> La suppression de l'offre est bien effectuée!</span>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                  <thead class="thead-light">
                    <tr>
                      ...
                      <th scope="col" class="sort" data-sort="">prof propriétaire</th>
                      <th scope="col">Prix</th>
                      <th scope="col" class="sort" data-sort="">Date de publication</th>
                      <th scope="col">Supprimer offre</th>
                    </tr>
                  </thead>
                  <tbody class="list">
                  
                  
                  <c:if test = "${all_offers_size > 0}">
                  <c:forEach var="i" begin="0" end="${all_offers_size-1}" step="1">
                    <tr>
                      <th scope="row">
                        <div class="media align-items-center">
                          <a href="#" class="avatar  mr-3">
                            <img alt="Image placeholder" src="${all_offers[i].getImage()}" class="bg-white">
                          </a>
                          <div class="media-body">
                            <span class="name mb-0 text-sm">${all_offers[i].getInfos()}</span>
                          </div>
                        </div>
                      </th>
  
                      <td class="">
                        ${all_offers[i].getProf_name()}
                      </td>
  
                      <td>
                        ${all_offers[i].getPrix()} DH
                      </td>
  
                      <td>
                        ${all_offers[i].getDate()}
                      </td>
                        ...
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
							...
							<form action="supprimer_servlet" method="get">
                          		<input type="hidden" name="offre_to_delete" value="${all_offers[i].getId_offre()}" >
              ...
              <c:if test = "${all_offers_size == 0}">
                    <h1 class="text-center my-4">Aucun offre à affiché</h1>
               </c:if>
            </div>
            <!-- Card footer -->
