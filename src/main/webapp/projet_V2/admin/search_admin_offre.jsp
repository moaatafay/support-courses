          ...
          <div class="card">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                  ...
                  <c:if test = "${search_offre_list_size > 0}">
                  <c:forEach var="i" begin="0" end="${search_offre_list_size-1}" step="1">
                    <tr>
                      <th scope="row">
                        <div class="media align-items-center">
                          <a href="#" class="avatar  mr-3">
                            <img alt="Image placeholder" src="${search_offre_list[i].getImage()}" class="bg-white">
                          </a>
                          <div class="media-body">
                            <span class="name mb-0 text-sm">${search_offre_list[i].getInfos()}</span>
                          </div>
                        </div>
                      </th>
  
                      <td class="">
                        ${search_offre_list[i].getProf_name()}
                      </td>
  
                      <td>
                        ${search_offre_list[i].getPrix()} DH
                      </td>
  
                      <td>
                        ${search_offre_list[i].getDate()}
                      </td>
                      ...
                      <td class="">
                        <div class="dropdown">
                          ...
                          <input type="hidden" name="offre_to_delete" value="${search_offre_list[i].getId_offre()}" >
                          <button type="submit" class="dropdown-item">Oui</button>
                          </form>
                            <a class="dropdown-item" href="students-admin.html">Non</a>
                          </div>
                      </div>
                      </td>
                    </tr>
