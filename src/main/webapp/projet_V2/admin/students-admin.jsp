...
<body>
  ...
  <div class="main-content" id="panel">
          ...
          <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" method="Get" action="search_servlet">
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <input class="form-control" placeholder="Search" name="search_student" type="text">
              </div>
            </div>
    ...
    <div class="container mt-6">
      ...
      <c:if test = "${delete_success_student == 1}">
      <div class="delete">
	      	<div class="alert alert-success alert-dismissible fade show" role="alert">
			    <span class="alert-icon"><i class="ni ni-like-2"></i></span>
			    <span class="alert-text"><strong>Success!</strong> La suppression de l'étudiant est bien effectuée! </span>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="">Offres effectés</th>
                    <th scope="col">Supprimer étudiant</th>
                  </tr>
                </thead>
                <tbody class="list">
                  
                  <c:if test = "${all_students_size > 0}">
                  <c:forEach var="i" begin="0" end="${all_students_size-1}" step="1">
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image placeholder" src="${all_students[i].getImg()}">
                        </a>
                        <div class="media-body">
                          <span class="name mb-0 text-sm">${all_students[i].getName()} ${all_students[i].getFamily_name()}</span>
                        </div>
                      </div>
                    </th>
                    ...
                    <td>
                      ${all_students[i].getEmail()}
                    </td>
                    
                    <td>
                      ${all_students[i].getCity()}
                    </td>

                    <td>
                      ${all_students[i].getOffres_accepted()}
                    </td>
                    ...
                    <td class="">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          ...
                          <input type="hidden" name="student_to_delete" value="${all_students[i].getId_students()}" >
                          <button type="submit" class="dropdown-item">Oui</button>
                          </form>
                          <a class="dropdown-item" href="offres.html">Non</a>
                        </div>
                    </div>
                    </td>
                  </tr>
              ...
              <c:if test = "${all_students_size == 0}">
                    <h1 class="text-center my-4">Aucun étudiant à affiché</h1>
               </c:if>
            </div>
            <!-- Card footer -->
