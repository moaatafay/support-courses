        ...
        <div class="col">
          <div class="card">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                  <thead class="thead-light">
                    <tr>
                      ...
                      <th scope="col">étudiant assisté</th>
                  ...
                  <c:if test = "${all_offers_effect_size > 0}">
                  <c:forEach var="i" begin="0" end="${all_offers_effect_size-1}" step="1">
                    <tr>
                      <th scope="row">
                        <div class="media align-items-center">
                          ...
                          <div class="media-body">
                            <span class="name mb-0 text-sm">${all_offers_effect[i].matiere}</span>
                          </div>
                        </div>
                      </th>
  
                      <td class="">
                        ${all_offers_effect[i].prof_name} ${all_offers_effect[i].prof_family_name}
                      </td>
  
                      <td>
                        ${all_offers_effect[i].student_name} ${all_offers_effect[i].student_family_name}
                      </td>
  
                      <td>
                        ${all_offers_effect[i].date}
                      </td>
                      
                      <td class="">
                        ${all_offers_effect[i].rate}
                      </td>
                      <td class="">
                        ${all_offers_effect[i].lebelle} 
                      </td>
                    </tr>
                    </c:forEach>
                    </c:if>
              ...
              <c:if test = "${all_offers_effect_size == 0}">
                    <h1 class="text-center my-4">Aucun offre effectué à affiché</h1>
               </c:if>
            </div>
            <!-- Card footer -->
