            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                  ...
                  <c:if test = "${search_prof_list_size > 0}">
	                  <c:forEach var="i" begin="0" end="${search_prof_list_size-1}" step="1">
	                  	<tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image placeholder" src="${search_prof_list[i].getImg()}">
                        </a>
                        <div class="media-body">
                          <span class="name mb-0 text-sm">${search_prof_list[i].getName()} ${search_prof_list[i].getFamily_name()}</span>
                        </div>
                      </div>
                    </th>

                    <td class="">
                      ${search_prof_list[i].getBio()}
                    </td>

                    <td>
                      ${search_prof_list[i].getEmail()}
                    </td>

                    <td>
                     ${search_prof_list[i].getCity()}
                    </td>
