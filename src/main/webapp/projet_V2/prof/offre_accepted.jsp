            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                 ...
                 <c:if test = "${prof_accept_list_size>=1}">
                    <c:forEach var="i" begin="0" end="${prof_accept_list_size-1 }" step="1">
                  
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image" src="${prof_accept_list[i].image }">
                        </a>
                        <div class="media-body">
                          <span class="name mb-0 text-sm">${prof_accept_list[i].matiere}</span>
                        </div>
                      </div>
                    </th>
                    <td class="budget">
                      ${prof_accept_list[i].prix} USD
                    </td>
                    <td>
                     <span class="badge badge-dot mr-4">
                       
                        <span class="status">${prof_accept_list[i].email }</span>
                      </span>
                    </td>
                    <td>
                     <span>${prof_accept_list[i].localisation }</span>
                    </td>
                    <td>
                      <div class="d-flex align-items-center">
                         <span class="completion mr-2">${prof_accept_list[i].date }<br>${prof_accept_list[i].start }-->${prof_accept_list[i].finish }</span>
                      </div>
                    </td>
                   <!-- <td class="text-right">
                        <div class="dropdown">
