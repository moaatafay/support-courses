          ...
          <div class="card">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
               <c:if test = "${search_prof_offre_created_list_size>=1}">
                <c:forEach var="i" begin="0" end="${search_prof_offre_created_list_size-1 }" step="1">
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image placeholder" src="${search_prof_offre_created_list[i].img}">
                        </a>
                        <div class="media-body">
                          <span class="name mb-0 text-sm">${search_prof_offre_created_list[i].matiere }</span>
                        </div>
                      </div>
                    </th>
                    <td class="budget">
                      ${search_prof_offre_created_list[i].prix } USD
                    </td>
                    <td>
                      <div class="txt-center">
                      <div class="trainer-rank d-flex align-items-center">
                          <span class="mr-2">${search_prof_offre_created_list[i].moyenne}</span><i class="far fa-star"></i>
                      </div>
                      </div>
                    </td>
                    <td>
                      <span class="completion mr-2">
                        ${search_prof_offre_created_list[i].date }
                      </span>
                    </td>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                       <form action="button_offre_update" method="get">
                        ...
                        <input type="hidden" value="${search_prof_offre_created_list[i].id_offre}" name="hidden">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          ...
                          <form action="Drop_offre_prof" method="post">
	                         ...
	                         <input type="hidden" name="id_profs"  value="${prof.id_profs}"/>
	                          <input type="hidden" name="id_offre"  value="${search_prof_offre_created_list[i].id_offre}"/>
	                          <input type="hidden" name="matiere"  value="${search_prof_offre_created_list[i].matiere}"/>
                          </form>
