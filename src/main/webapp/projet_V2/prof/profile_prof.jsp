...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <div class="header bg-primary py-1">
      <div class="container-fluid mt--2">
        <div class="header-body">
          ...
          <h1 class="text-white my-5 fs-1 text-center">Bonjour ${prof.name} !</h1>
    ...
    <div class="container-fluid">
      <a href="edit_profile_prof.jsp" class="btn py-2 px-3 btn-success float-right mt--3">Edit Profile</a>
          ...
          <div class="card card-profile">
            ...
            <div class="row justify-content-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="${prof.img}" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-4 mt-4">
              ...
              <div class="text-center">
                ...
                <div>
                  <i class="ni education_hat mr-2"></i>${prof.city}
                </div>
              </div>
            </div>
          </div>
