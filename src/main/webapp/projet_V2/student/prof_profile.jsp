          ...
          <div class="card card-profile">
            ...
            <div class="row justify-content-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="${show_this_prof.img}" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-6">
              ...
              <div class="text-center">
                <h5 class="h3">
                  ${show_this_prof.name} ${show_this_prof.family_name}
                </h5>
                
                <div class="h5 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i>${show_this_prof.email}
                </div>
                <div class="h5 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i>${show_this_prof.city}
                </div>
                <div class="h5 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i>${show_this_prof.bio}
                </div>
              </div>
            </div>
          </div>
