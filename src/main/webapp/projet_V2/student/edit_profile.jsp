            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                    ...
                    <img src="${student.img}" class="rounded-circle" style="border-radius:0.5">
                    <label class=dot><input type="file" name="img" value="${student.img}"><i class="fas fa-camera"></i></label>
                </div>
              </div>
            </div>
              ...
              <form action="edit_profile" method="post">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" id="input-username" class="form-control" placeholder="${student.name}" ">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Email address</label>
                        <input type="email" name="email" id="input-email" class="form-control" placeholder="${student.email}">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="family_name" id="input-first-name" class="form-control" placeholder="${student.family_name}">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input name="city" id="input-address" class="form-control" placeholder="${student.city}" type="text">
                      </div>
                    </div>
                  </div>
                 </div>
                ...
                <div class="pl-lg-4">
                  <div class="form-group">
                    ...
                    <textarea name="bio" rows="4" class="form-control" placeholder="${student.bio}"></textarea>
                  </div>
                </div>
                    </div>
